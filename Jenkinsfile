    ...
    stages {
        ...
        stage ('Test Release')
        {
            steps
            {
                ...
                dotnetTest logger: 'trx;LogFileName=test.core.typeindexstorage.trx', project: 'src/Tests/DatenMeister.Tests/DatenMeister.Core.TypeIndexStorage.Tests.csproj', configuration: 'Release', continueOnError: true
