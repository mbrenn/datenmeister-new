...
|metaClass|If the selected object or the list behind it is of this object type, this association can be selected. (e.g. Class listing items of *Property* instances)
|includeGeneralization|true, if also Generalizations of the given object shall be regarded as matching
...
|parentMetaClass|If properties of a list are selected and the owning object is of this type, this can be selected. (e.g. *Class* listing items of Property instances)
|parentProperty|If properties of a list are selected and this list is in this property of the owning object, this can be selected. (e.g. Class listing items in *ownedAttribute*)
