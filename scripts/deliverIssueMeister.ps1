...
Remove-Item -Force -Recurse -Path deliverables/IssueMeister
New-Item -ItemType Directory -Force -Path deliverables/IssueMeister

cd src\DatenMeisterWPF\bin\Release\netcoreapp3.0

Copy-Item -Path "./*" -Destination "../../../../../deliverables/IssueMeister" -Recurse 
