...
Remove-Item -Force -Recurse -Path deliverables/StundenMeister
New-Item -ItemType Directory -Force -Path deliverables/StundenMeister

cd src\Apps\StundenMeister\bin\Release\netcoreapp3.0

Copy-Item -Path "./*" -Destination "../../../../../../deliverables/StundenMeister" -Recurse 
