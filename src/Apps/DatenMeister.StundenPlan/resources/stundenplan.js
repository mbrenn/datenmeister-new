...
export function init() {
    ...
    describe('StundenPlanMeister Tests', function () {
        ...
        it('Test Event Manager', function () {
            ...
            chai.assert(tuesdayFirstWeek[0].get(StundenPlanTypes._Types._WeeklyPeriodicEvent._name_, Mof.ObjectType.String) === "Event1", "Event1 not on first Tuesday");
            const tuesdaySecondWeek = manager.getEventsOnWeekday(1, 2);
            chai.assert(tuesdaySecondWeek.length === 1, "Tuesday second week");
            chai.assert(tuesdaySecondWeek[0].get(StundenPlanTypes._Types._WeeklyPeriodicEvent._name_, Mof.ObjectType.String) === "Event1", "Event1 not on second tuesday");
            ...
            chai.assert(wednesdayFirstWeek[0].get(StundenPlanTypes._Types._WeeklyPeriodicEvent._name_, Mof.ObjectType.String) === "Event2", "Event2 not on first Wednesday");
            ...
            chai.assert(wednesdaySecondWeek[0].get(StundenPlanTypes._Types._WeeklyPeriodicEvent._name_, Mof.ObjectType.String) === "Event3", "Event3 not on second Wednesday");
            // Check Ordering
            const thursdayFirstWeek = manager.getEventsOnWeekday(0, 4);
            chai.assert(thursdayFirstWeek.length === 2, "Thursday first week");
            chai.assert(thursdayFirstWeek[0].get(StundenPlanTypes._Types._WeeklyPeriodicEvent._name_, Mof.ObjectType.String) === "Event5", "Event5 as first Thursday event");
            chai.assert(thursdayFirstWeek[1].get(StundenPlanTypes._Types._WeeklyPeriodicEvent._name_, Mof.ObjectType.String) === "Event4", "Event4 as second Thursday event");
        });
    });
}
...
class PeriodicEventManager {
    ...
    getEventsOnWeekday(week, day) {
        ...
        for (const n in this.events) {
            ...
            const weekOffset = event.get(StundenPlanTypes._Types._WeeklyPeriodicEvent.weekOffset, Mof.ObjectType.Number)
                ?? 0;
            let weekInterval = event.get(StundenPlanTypes._Types._WeeklyPeriodicEvent.weekInterval, Mof.ObjectType.Number);
