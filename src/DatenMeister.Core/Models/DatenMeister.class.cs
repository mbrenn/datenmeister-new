...
namespace DatenMeister.Core.Models
{
    ...
    {
        public static readonly _DatenMeister TheOne = new();

        public _Actions Actions = new();

        public _AttachedExtent AttachedExtent = new();

        public _CommonTypes CommonTypes = new();

        public _DataViews DataViews = new();

        public _DynamicRuntimeProvider DynamicRuntimeProvider = new();

        public _ExtentLoaderConfigs ExtentLoaderConfigs = new();

        public _FastViewFilters FastViewFilters = new();

        public _Forms Forms = new();

        public _Management Management = new();
        ...
        public class _DataViews
        {
            ...
            public _ComparisonMode ComparisonMode = new();

            public _DataView DataView = new();

            public _DynamicSourceNode DynamicSourceNode = new();

            public _FilterPropertyNode FilterPropertyNode = new();

            public _FilterTypeNode FilterTypeNode = new();

            public _FlattenNode FlattenNode = new();

            public _SelectByFullNameNode SelectByFullNameNode = new();

            public _SourceExtentNode SourceExtentNode = new();
        ...
        public class _Reports
        {
            ...
            public _DescendentMode DescendentMode = new();
            ...
            public class _Elements
            {
                ...
                public _ReportTableForTypeMode ReportTableForTypeMode = new();
        ...
        public class _Forms
        {
            ...
            public _FormType FormType = new();

            public _FullNameFieldData FullNameFieldData = new();

            public _ListForm ListForm = new();
        ...
        public class _Management
        {
            ...
            public _ExtentLoadingState ExtentLoadingState = new();
        ...
        public class _FastViewFilters
        {
            ...
            public IElement __PropertyComparisonFilter =
                new MofObjectShadow(
            ...
            public _ComparisonType ComparisonType = new();
