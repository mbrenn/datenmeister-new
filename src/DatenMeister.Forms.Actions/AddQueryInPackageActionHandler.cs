...
public class AddQueryInPackageActionHandler : IActionHandler
{
    ...
    {
        var targetWorkspace =
            action.getOrDefault<string>(_Actions._Forms._AddQueryInPackageAction.targetPackageWorkspace);
        var targetUri =
            action.getOrDefault<string>(_Actions._Forms._AddQueryInPackageAction.targetPackageUri);
        ...
        var queryStatement = action.getOrDefault<IElement>(_Actions._Forms._AddQueryInPackageAction.query);
