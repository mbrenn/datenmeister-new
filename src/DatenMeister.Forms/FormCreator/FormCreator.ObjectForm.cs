...
namespace DatenMeister.Forms.FormCreator
{
    public partial class FormCreator
    {
        ...
        { 
            ...
            // propertyNamesWithoutCollection containing all properties which have a collection as a subitem ==> Row Form
            if (propertiesWithoutCollection.Any() || creationMode.AutomaticMetaClassField)
            {
                ...
                if (!cache.MetaClassAlreadyAdded
                    ...
                    && !new FormMethods(_workspaceLogic, _scopeStorage).HasMetaClassFieldInForm(
                        detailForm.get<IReflectiveCollection>(_DatenMeister._Forms._RowForm.field)!))
                {
                    ...
                    detailForm.AddCollectionItem(_DatenMeister._Forms._RowForm.field, metaClassField);
            ...
            foreach (var pair in propertiesWithCollection)
            {
                ...
                if (propertyName == _UML._Packages._Package.packagedElement)
                {
                    ...
                    if (elementsWithoutMetaClass.Any() || !elementsAsObjects.Any())
                    {
                        ...
                        form.set(_DatenMeister._Forms._TableForm.name, "packagedElements without MetaClass");
