...
namespace DatenMeister.Forms.FormCreator
{
    public partial class FormCreator
    {
        ...
        {
            var result = MofFactory.create(_DatenMeister.TheOne.Forms.__TableForm);
            result.set(_DatenMeister._Forms._TableForm.isAutoGenerated, true);
            
            AddToListFormByElements(result, elements, creationMode with { IsForTableForm = true });
        ...
        public IElement CreateTableFormForPropertyValues(
            IObject? element,
            string propertyName,
            ...
            FormFactoryConfiguration creationMode)
        {
            ...
            AddFieldsToRowOrObjectFormByMetaClass(result, propertyType, creationMode);
            result.set(_DatenMeister._Forms._TableForm.property, propertyName);
            result.set(_DatenMeister._Forms._TableForm.metaClass, propertyType);
            result.set(_DatenMeister._Forms._TableForm.title,
            ...
            IElement? property = null)
        {
            ...
            if (metaClass != null)
            {
                AddFieldsToRowOrObjectFormByMetaClass(form, metaClass, creationMode with { IsForTableForm = true });
            ...
            FormFactoryConfiguration creationMode)
        {
            ...
            foreach (var element in elements.OfType<IObject>())
            {
                ...
                if (creationMode.CreateByMetaClass && metaClass != null)
                {
                    ...
                    AddFieldsToRowOrObjectFormByMetaClass(form, metaClass, creationMode with { IsForTableForm = true }, cache);
                }
        ...
        public IElement CreateTableFormForProperty(IElement property, FormFactoryConfiguration creationMode)
        {
            ...
            if (propertyType != null) AddFieldsToRowOrObjectFormByMetaClass(result, propertyType, creationMode);
            result.set(_DatenMeister._Forms._TableForm.property, propertyName);
