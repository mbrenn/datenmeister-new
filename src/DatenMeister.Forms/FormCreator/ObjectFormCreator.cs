    ...
    : FormCreator, IObjectFormFactory
{
    ...
    { 
        ...
        if (propertiesWithoutCollection.Any() || creationMode.AutomaticMetaClassField)
        {
            ...
            foreach (var pair in propertiesWithoutCollection)
            {
                ...
                var field = fieldCreator.CreateFieldForProperty(property,
                    pair.propertyName,
                    creationMode);
    ...
    /// <param name="context">Configuration of the Form Factory</param>
    ...
    public IElement CreateObjectFormForMetaClass(IElement metaClass, FormFactoryContext context)
    {
        ...
        var rowForm = rowFormCreator.CreateRowFormByMetaClass(metaClass, context);
