...
public class CollectionFormFactory(IWorkspaceLogic workspaceLogic, IScopeStorage scopeStorage)
    : FormFactoryBase(workspaceLogic, scopeStorage), ICollectionFormFactory
{
    /// <summary>
    ///     Defines the logger
    /// </summary>
