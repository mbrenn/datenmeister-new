...
public class CollectionFormFactory : FormFactoryBase, ICollectionFormFactory
{
    ...
    /// <param name="context">Configuration defining the way how the form shall
    /// be created</param>
    /// <returns>The collection form being created</returns>
    public IElement? CreateCollectionFormForMetaClass(IElement metaClass, FormFactoryContext context)
    {
        ...
        {
            foundForm = CollectionFormHelper.CreateCollectionFormFromTabs(foundForm);
    ...
    /// <param name="context">Configuration which defines the way of how this form
        ...
        FormFactoryContext context)
    {
        ...
        if (foundForm == null && context.ViaFormCreator)
        {
            ...
            var formCreator = new CollectionFormCreator(WorkspaceLogic, ScopeStorage);
            foundForm = formCreator.CreateCollectionFormForCollection(
                extent,
                extent.elements(),
                context);
