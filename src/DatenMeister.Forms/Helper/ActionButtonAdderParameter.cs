...
/// Defines the parameter for the ActionButtonToFormadder
/// </summary>
public class NewActionButtonAdderParameter
{
    public NewActionButtonAdderParameter(string actionName, string title, string buttonText = "")
    {
    ...
    /// during issue finding
    /// </summary>
    public Action<IObject?, NewActionButtonAdderParameter>? OnCall { get; set; }
    ...
    /// This allows setting a breakpoint for the debugger during issue finding
    /// </summary>
    public Action<IObject?, NewActionButtonAdderParameter>? OnCallSuccess { get; set; }
}