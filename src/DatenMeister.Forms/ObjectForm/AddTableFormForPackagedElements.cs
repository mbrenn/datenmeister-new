...
public class AddTableFormForPackagedElements : FormFactoryBase, IObjectFormFactory
{
        ...
        FormCreationResultOneForm result)
    {
        ...
        if (elementsWithoutMetaClass.Any() || !elementsAsObjects.Any())
        {
            ...
            form.set(_Forms._FormTypes._TableForm.name, "packagedElements without MetaClass");
            form.set(_Forms._FormTypes._TableForm.property, _UML._Packages._Package.packagedElement);
            form.set(_Forms._FormTypes._TableForm.noItemsWithMetaClass, true);
            form.set(_Forms._FormTypes._TableForm.isAutoGenerated, true);
        ...
        foreach (var metaClass in elementsWithMetaClass)
        {
            ...
            {
                form.set(_Forms._FormTypes._TableForm.name, $"PackagedElements of type '{NamedElementMethods.GetName(metaClass)}'");
                form.set(_Forms._FormTypes._TableForm.property, _UML._Packages._Package.packagedElement);
