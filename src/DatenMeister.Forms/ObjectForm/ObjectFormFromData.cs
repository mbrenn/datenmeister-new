...
public class ObjectFormFromData : FormFactoryBase, IObjectFormFactory
{
        ...
        FormCreationResultOneForm result)
    {
        ...
        result.Form ??= factory.create(_Forms.TheOne.FormTypes.__ObjectForm);
        ...
        if (element != null)
        {
            ...
            result.Form.set(
                _Forms._FormTypes._ObjectForm.name,
            ...
            result.AddToFormCreationProtocol(
                "[ObjectFormFromData.CreateObjectForm]: Create Object Form");
            ...
            detailForm.set(_Forms._FormTypes._RowForm.name, "Detail");
            detailForm.set(_Forms._FormTypes._RowForm.isAutoGenerated, true);

            tabs.Add(detailForm);

            result.AddToFormCreationProtocol(
                "[ObjectFormFromData.CreateObjectForm]: Create DetailForm into Extent");
            ...
            foreach (var pair in propertiesWithCollection)
            {
                ...
                result.AddToFormCreationProtocol(
                    "[ObjectFormFromData.CreateObjectForm]: Add Table Form for by reflective collection: " +
                    pair.propertyName);
                ...
                {
                    form.set(_Forms._FormTypes._TableForm.name, $"Property: {pair.propertyName}");
                    form.set(_Forms._FormTypes._TableForm.property, pair.propertyName);
                    tabs.Add(form);
                }
            }

            // ReSharper restore HeuristicUnreachableCode
            result.Form.set(_Forms._FormTypes._ObjectForm.tab, tabs);
