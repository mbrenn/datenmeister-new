...
public class ObjectFormFromData : INewObjectFormFactory
{
    ...
    public void CreateObjectFormForItem(IObject element, NewFormCreationContext context, FormCreationResult result)
    {
        ...
        var propertiesWithoutCollection =
            (from p in propertyNamesWithoutCollection.Distinct(new FieldCreationHelper.P.PropertyNameEqualityComparer())
    ...
    public void CreateObjectFormForMetaClass(
        IElement? metaClass, 
        ...
        FormCreationResult result)
    {
        if (metaClass == null)
        {
            // We do not manage non-resolved metaclasses
            return;
        }
        ...
        var rowForm = FormCreation.CreateRowFormForMetaClass(metaClass, context);
