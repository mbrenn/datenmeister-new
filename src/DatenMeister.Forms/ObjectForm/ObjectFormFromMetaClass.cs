...
public class ObjectFormFromMetaClass(IWorkspaceLogic workspaceLogic) : FormFactoryBase, IObjectFormFactory
{
        ...
        FormCreationResultOneForm result)
    {
        ...
        if (parameterMetaclass != null)
        {
            ...
            result.Form.set(_Forms._FormTypes._RowForm.isAutoGenerated, true);
            result.Form.set(
                _Forms._FormTypes._RowForm.name,
            ...
            foreach (var pair in propertyNamesWithCollection)
            {
                ...
                {
                    form.set(_Forms._FormTypes._TableForm.name, $"Property: {propertyName}");
                    form.set(_Forms._FormTypes._TableForm.property, propertyName);
