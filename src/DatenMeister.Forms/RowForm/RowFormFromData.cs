...
public class RowFormFromData(IWorkspaceLogic workspaceLogic) : FormFactoryBase, IRowFormFactory
{
        ...
        FormCreationResultMultipleForms result)
    {
        ...
        {
            result.Forms.Add(context.Global.Factory.create(_Forms.TheOne.FormTypes.__RowForm));
        }

        var createdForm = result.Forms.First();
        
        // Just get the properties by the property values
