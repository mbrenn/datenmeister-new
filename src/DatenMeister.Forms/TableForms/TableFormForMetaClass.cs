...
{   
        ...
        FormCreationResultMultipleForms result)
    {
        ...
        {
            result.Forms.Add(context.Global.Factory.create(_Forms.TheOne.FormTypes.__TableForm));
        };
        
        var createdForm = result.Forms.First();
        createdForm.set(_Forms._FormTypes._TableForm.isAutoGenerated, true);
        ...
        createdForm.set(_Forms._FormTypes._TableForm.metaClass, metaClass);
