...
public class XmiPlugin(IScopeStorage scopeStorage) : IDatenMeisterPlugin
{
    private readonly ProviderToProviderLoaderMapper _storageMapper = scopeStorage.Get<ProviderToProviderLoaderMapper>();
