...
namespace DatenMeister.WPF.Forms.Base.ViewExtensions
{
    ...
    /// </summary>
    public class ItemMenuButtonDefinition : RibbonButtonDefinition
    {
        ///<summary>
        ...
        public ItemMenuButtonDefinition(string name, Action<IObject> onPressed, string imageName, string categoryName, int priority = 0) : base(name, imageName, categoryName, priority)
        {
            OnPressed = onPressed;
        }
