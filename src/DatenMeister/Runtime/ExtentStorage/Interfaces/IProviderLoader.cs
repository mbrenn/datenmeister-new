...
namespace DatenMeister.Runtime.ExtentStorage.Interfaces
{
    ...
    public interface IProviderLoader
    {
        ...
        /// </summary>
        /// <param name="configuration">Configuration to be used to retrieve the information</param>
        ...
        IProvider LoadProvider(ExtentLoaderConfig configuration, bool createAlsoEmpty);
