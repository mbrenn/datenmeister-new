...
namespace DatenMeister.Runtime.Workspaces
{
    public interface IWorkspaceLogic
    {
        ...
        TFilledType Create<TFiller, TFilledType>(Workspace layer)
        ...
        TFilledType Get<TFilledType>(Workspace layer)
            where TFilledType : class, new();
        ...
        void ClearCache(Workspace layer);
        ...
        void Set<TFilledType>(Workspace layer, TFilledType value)
            where TFilledType : class, new();
