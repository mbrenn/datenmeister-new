...
public class JsonCompressedLoadingTests
{
    ...
    public void TestCompressedJsonSimple()
    {
      ...
      Assert.That(secondElement.getOrDefault<int>("age"), Is.EqualTo(42));
    }
    ...
    public void TestCompressedJsonComplex()
    {
      ...
      Assert.That(hobbies.OfType<string>().ElementAt(0), Is.EqualTo("running"));
      
      
      var address = secondElement.getOrDefault<IElement>("address");
      Assert.That(address, Is.Not.Null);
      Assert.That(address.getOrDefault<string>("town"), Is.EqualTo("Frankfurt"));
    }


    public const string SimpleCompressedJson =
        """
        {
          "data": [
            "name",
    ...
    public const string ComplexCompressedJson =
      """
      {
        "data": [
          "name",
