...
public class CreateFormByMetaClassActionTests
{
    ...
    public async Task TestCreationOfObjectAssociationForm()
    {
        ...
        var autoGeneratedForm = 
            formFactory.CreateObjectFormForMetaClass(_zipModel.ZipCodeWithState!, new FormFactoryContext());
        ...
        var objectForm = formFactory.CreateObjectFormForMetaClass(_zipModel.ZipCodeWithState, new FormFactoryContext());
