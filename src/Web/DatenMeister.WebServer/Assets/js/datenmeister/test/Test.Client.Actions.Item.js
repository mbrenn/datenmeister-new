        ...
        describe('Actions', () => {
            describe('Item', () => {
                ...
                it('MoveUp/Down in Collection', async () => {
                    ...
                    const subChild1 = await ClientItems.createItemAsChild("Test", "dm:///unittest#" + result.itemId, { property: "packagedElement", asList: true });
                    await ClientItems.setProperty("Test", subChild1.itemId, "name", "Child 1");
                    const subChild2 = await ClientItems.createItemAsChild("Test", "dm:///unittest#" + result.itemId, { property: "packagedElement", asList: true });
                    await ClientItems.setProperty("Test", subChild2.itemId, "name", "Child 2");
                    const subChild3 = await ClientItems.createItemAsChild("Test", "dm:///unittest#" + result.itemId, { property: "packagedElement", asList: true });
                    ...
                    assert.isTrue(children.length === 3, "Length of array has to be 3");
                ...
                it('MoveUp/Down in Extent', async () => {
                    await ClientItems.deleteRootElements("Test", "dm:///unittest");
                    const subChild1 = await ClientItems.createItemInExtent("Test", "dm:///unittest", {});
                    await ClientItems.setProperty("Test", subChild1.itemId, "name", "Child 1");
                    const subChild2 = await ClientItems.createItemInExtent("Test", "dm:///unittest", {});
                    await ClientItems.setProperty("Test", subChild2.itemId, "name", "Child 2");
