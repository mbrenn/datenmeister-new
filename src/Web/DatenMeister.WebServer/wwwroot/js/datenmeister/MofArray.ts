 ...
 */
export function moveItemInArrayUpByUri(elements: Array<Mof.DmObject>, workspace: string, itemUri: string) {
 ...
 */
export function moveItemInArrayDownByUri(elements: Array<Mof.DmObject>, workspace: string, itemUri: string) {
