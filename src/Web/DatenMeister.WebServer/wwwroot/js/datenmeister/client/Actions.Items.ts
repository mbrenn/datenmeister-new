...
import _MoveUpDownAction = _DatenMeister._Actions._MoveUpDownAction;
import _MoveDirectionType = _DatenMeister._Actions._MoveDirectionType;
...
async function moveItemInCollection(workspace: string, parentUri: string, propertyName: string | undefined, elementUri: string, direction: string) {
    const action = new Mof.DmObject(_DatenMeister._Actions.__MoveUpDownAction_Uri);
