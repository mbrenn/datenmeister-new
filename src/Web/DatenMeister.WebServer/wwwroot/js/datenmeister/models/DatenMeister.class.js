...
(function (_Actions) {
    ...
    class _LoadElementAction {
    }
    _LoadElementAction.workspace = "workspace";
    _LoadElementAction.url = "url";
    _LoadElementAction._name_ = "name";
    _LoadElementAction.isDisabled = "isDisabled";
    _Actions._LoadElementAction = _LoadElementAction;
    _Actions.__LoadElementAction_Uri = "dm:///_internal/types/internal#65f30a58-9f6c-4bc6-9290-2349265dceaa";
})(_Actions || (_Actions = {}));
