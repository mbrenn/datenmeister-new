...
(function (_ExtentLoaderConfigs) {
    ...
    _ExcelLoaderConfig.importType = "importType";
    _ExcelLoaderConfig.xmiFilePath = "xmiFilePath";
    ...
    _ExcelReferenceLoaderConfig.importType = "importType";
    _ExcelReferenceLoaderConfig.xmiFilePath = "xmiFilePath";
    ...
    _ExcelImportLoaderConfig.importType = "importType";
    _ExcelImportLoaderConfig.xmiFilePath = "xmiFilePath";
    ...
    _ExcelExtentLoaderConfig.fixRowCount = "fixRowCount";
    _ExcelExtentLoaderConfig.fixColumnCount = "fixColumnCount";
    _ExcelExtentLoaderConfig.filePath = "filePath";
    _ExcelExtentLoaderConfig.sheetName = "sheetName";
    _ExcelExtentLoaderConfig.offsetRow = "offsetRow";
    _ExcelExtentLoaderConfig.offsetColumn = "offsetColumn";
    _ExcelExtentLoaderConfig.countRows = "countRows";
    _ExcelExtentLoaderConfig.countColumns = "countColumns";
    _ExcelExtentLoaderConfig.hasHeader = "hasHeader";
    _ExcelExtentLoaderConfig.tryMergedHeaderCells = "tryMergedHeaderCells";
    _ExcelExtentLoaderConfig.onlySetColumns = "onlySetColumns";
    _ExcelExtentLoaderConfig.idColumnName = "idColumnName";
    _ExcelExtentLoaderConfig.skipEmptyRowsCount = "skipEmptyRowsCount";
    _ExcelExtentLoaderConfig.columns = "columns";
    _ExcelExtentLoaderConfig.importType = "importType";
    _ExcelExtentLoaderConfig.xmiFilePath = "xmiFilePath";
    ...
    _ExcelHierarchicalLoaderConfig.importType = "importType";
    _ExcelHierarchicalLoaderConfig.xmiFilePath = "xmiFilePath";
    ...
    (function (_ExtentLoaderImportType) {
        _ExtentLoaderImportType.NoSync = "NoSync";
        _ExtentLoaderImportType.ReadOnlySync = "ReadOnlySync";
        _ExtentLoaderImportType.BidirectionalSync = "BidirectionalSync";
    })(_ExtentLoaderImportType = _ExtentLoaderConfigs._ExtentLoaderImportType || (_ExtentLoaderConfigs._ExtentLoaderImportType = {}));
    let ___ExtentLoaderImportType;
    (function (___ExtentLoaderImportType) {
        ___ExtentLoaderImportType[___ExtentLoaderImportType["NoSync"] = 0] = "NoSync";
        ___ExtentLoaderImportType[___ExtentLoaderImportType["ReadOnlySync"] = 1] = "ReadOnlySync";
        ___ExtentLoaderImportType[___ExtentLoaderImportType["BidirectionalSync"] = 2] = "BidirectionalSync";
    })(___ExtentLoaderImportType = _ExtentLoaderConfigs.___ExtentLoaderImportType || (_ExtentLoaderConfigs.___ExtentLoaderImportType = {}));
...
(function (_Forms) {
    ...
    _TableForm.originalWorkspace = "originalWorkspace";
