...
export function createForReferenceExistingNode(workspaceId, nodeUri) {
    ...
    viewNode.set(_DatenMeister._DataViews._Node._ReferenceViewNode.name, "Reference to " + nodeUri);
    return viewNode;
}
...
export function createForFilterByMetaClass(input, metaClass, includeInherits) {
    ...
    viewNode.set(_DatenMeister._DataViews._Row._RowFilterByMetaclassNode.name, "Filter by metaclass " + metaClass.uri);
...
export function createForOrderByProperty(input, property, descending) {
    ...
    viewNode.set(_DatenMeister._DataViews._Row._RowOrderByNode.name, "Order by " + property + (descending ? " descending" : " ascending"));
    return viewNode;
}
...
export function createForLimit(input, limit) {
    ...
    viewNode.set(_DatenMeister._DataViews._Row._RowFilterOnPositionNode.name, "Limit to " + limit + " elements");
    return viewNode;
}
...
export function createForFilterByFreetext(input, freeText) {
    ...
    viewNode.set(_DatenMeister._DataViews._Row._RowFilterByFreeTextAnywhere.name, "Filter by free text " + freeText);
    return viewNode;
}
...
export function createForFilterByProperty(input, property, value, comparisonMode) {
    ...
    viewNode.set(_DatenMeister._DataViews._Row._RowFilterByPropertyValueNode.name, "Filter by property " + property + " with value " + value + " (" + comparisonMode + ")");
    return viewNode;
}
...
export function createForFlatten(input) {
    ...
    viewNode.set(_DatenMeister._DataViews._Row._RowFlattenNode.name, "Flatten");
    return viewNode;
}
...
export function createForAddDynamicSource(name) {
    ...
    dynamicSource.set(_DatenMeister._DataViews._Source._DynamicSourceNode.name, "Dynamic source " + name);
...
export function createForGetElementsOfExtent(workspaceId, extentUrl) {
    ...
    viewNode.set(_DatenMeister._DataViews._Source._SelectByExtentNode.name, "Select by extent " + extentUrl);
    return viewNode;
}
...
export function createForGetElementsByPath(workspaceId, path) {
    ...
    viewNode.set(_DatenMeister._DataViews._Source._SelectByPathNode.name, "Select by path " + path);
    return viewNode;
}
...
export function createForColumnFilterIncludeOnly(input, columnNamesComma) {
    ...
    viewNode.set(_DatenMeister._DataViews._Column._ColumnFilterIncludeOnlyNode.name, "Include-Only columns " + columnNamesComma);
    return viewNode;
}
...
export function createForColumnFilterExclude(input, columnNamesComma) {
    ...
    viewNode.set(_DatenMeister._DataViews._Column._ColumnFilterExcludeNode.name, "Exclude columns " + columnNamesComma);
    return viewNode;
}
