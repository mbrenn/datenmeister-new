...
export function includeTests() {
    describe('Forms', () => {
        ...
        it('Load Default Form for Extents', async () => {
            ...
            assert.isTrue(firstTab !== undefined, 'First tab is not defined');

            const fields = firstTab.get('field');
            assert.isTrue(fields !== undefined, 'fields are not defined');
            assert.isTrue(Array.isArray(fields), 'fields is not an array');
        ...
        it('Load Default Form for Detail', async () => {
            ...
            assert.isTrue(found, 'Fields do not contain a metaclass');
        ...
        it('Load ViewModes', async () => {
            ...
            assert.isTrue(found, "The Default viewMode was not found");
        });
